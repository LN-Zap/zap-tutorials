...
In case you don't already have an own LND node, you can create one with the project found below.<br />
...
To get there, you can either setup everything [from scratch] (/docs-android-manual-remote-node) or use some of the following projects that simplify the process: (alphabetically ordered)
<br />
...
[Guide](http://localhost:3000/docs-desktop-btcpay-server#step-2-obtain-btcpay-connection-details)
<br />
