...
This tutorial assumes you have already downloaded the new Zap Desktop v0.5.1 found [here](https://github.com/LN-Zap/zap-desktop/releases).

- Mac users will need to download _Zap-mac-v0.5.1-beta.dmg_
- Windows users will need to download _Zap-win-v0.5.1-beta.exe_
- Linux users will need to download _Zap-linux-x86_64-v0.5.1-beta.AppImage_
