...
# Zap iOS: Remote Node setup with LND Connect
...
GOGCCFLAGS="-fPIC -m64 -pthread -fno-caret-diagnostics -Qunused-arguments -fmessage-length=0 \
  -fdebug-prefix-map=/tmp/go-build005525529=/tmp/go-build -gno-record-gcc-switches"
```
...
not, see http://www.gnu.org/licenses/, or contact Free Software Foundation, Inc., 51
...
2. prize 6. under 7. cricket 8. style
3. fault 10. mix 11. expect 12. demand
4. reunion 14. smart 15. churn 16. volcano
5. item 18. fringe 19. harsh 20. fiction
6. another 22. certain 23. dry 24. mass
   ---------------END LND CIPHER SEED-----------------
